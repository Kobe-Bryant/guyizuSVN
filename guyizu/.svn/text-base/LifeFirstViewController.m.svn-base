...
@interface LifeFirstViewController ()

@end

@implementation LifeFirstViewController
...
- (void)viewDidLoad
{
    ...
    //创建视图控制器
    //分类
    FenleiViewController *fenleiCtl = [[FenleiViewController alloc]init];
    ...
    //发布
    FenleiViewController *sendCtl = [[FenleiViewController alloc]init];
    sendCtl.isFenlei = NO;
    UINavigationController *nav3 = [[UINavigationController alloc]initWithRootViewController:sendCtl];
    ...
    sendCtl.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithCustomView:leftbutton2];
